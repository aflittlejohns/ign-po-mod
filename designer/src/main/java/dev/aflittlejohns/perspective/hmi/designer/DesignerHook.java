...
import dev.aflittlejohns.perspective.hmi.common.components.flow.ValveNode;
...
//#TODO: Change the following to match the new components
  ...
  ComponentUtilities.registerComponentWithIcon(registry, ValveNode.DESCRIPTOR, "/images/display/status-valve-mp/component.icon.svg");
  }
 ...
 private void removeComponents() {
  ...
  registry.removeComponent(ValveNode.COMPONENT_ID);
 }
}
