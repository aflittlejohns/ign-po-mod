...
import type {  ValveCompoundContextType, ValveCompoundRootProps } from "../../../api/types";
...
const Root = ({ componentProps, valveProps, onActionPerformed, children }: ValveCompoundRootProps) => {
...
const valve = () => {
	const { valveProps, onActionPerformed, componentProps } = useValveContext("Valve");
