...
const plate = () => {
    ...
    return (React.createElement("div", Object.assign({ ref: elRef }, emit({
        ...
        React.createElement("div", { className: `${constants_1.IA_SYMBOL_COMPONENT_ROW}` },
            React.createElement("div", { className: `${constants_1.IA_SYMBOL_COMPONENT_WRAPPER}` },
                React.createElement("div", { className: `${constants_1.HMI_COMPONENT_CLASS} ${componentClassName}` }, componentItemNames.map(({ name, index, key }) => (React.createElement(item_1.default, { itemClassName: (0, utils_1.getClassNameWithStatus)(index, undefined, constants_1.hxElements, "heat-exchanger", 3, 3, 0, 0), key: key }))))))));
};
