...
const ParameterListComponent = (props) => {
    ...
    return (React.createElement(React.Fragment, null, transformedProps.map((param, index) => {
        const { input } = param;
