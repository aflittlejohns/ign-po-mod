...
const CommandValveMp = (props) => {
     ...
     */
    function resolver(prefix, keys, newValues, oldValues) {
    ...
    (0, react_1.useEffect)(() => {
        ...
        try {
            if (main && ((_a = props.props.command) === null || _a === void 0 ? void 0 : _a.main)) {
                resolver("command.main", ["auto", "manual", "off", "on"], main, props.props.command.main);
            }
        }
        catch (e) {
            console.log(e);
        }
        if (lowerSeat && ((_b = props.props.command) === null || _b === void 0 ? void 0 : _b.lowerSeat)) {
            resolver("command.lowerSeat", ["off", "on"], lowerSeat, props.props.command.lowerSeat);
        }
        if (upperSeat && ((_c = props.props.command) === null || _c === void 0 ? void 0 : _c.upperSeat)) {
            resolver("command.upperSeat", ["off", "on"], upperSeat, props.props.command.upperSeat);
        }
    }, [
        (_a = state.command) === null || _a === void 0 ? void 0 : _a.main,
        (_b = props.props.command) === null || _b === void 0 ? void 0 : _b.main,
        (_c = state.command) === null || _c === void 0 ? void 0 : _c.lowerSeat,
        (_d = props.props.command) === null || _d === void 0 ? void 0 : _d.lowerSeat,
        (_e = state.command) === null || _e === void 0 ? void 0 : _e.upperSeat,
        (_f = props.props.command) === null || _f === void 0 ? void 0 : _f.upperSeat,
    ]);
