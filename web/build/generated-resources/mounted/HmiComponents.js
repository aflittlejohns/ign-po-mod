...
const CommandValveMp = (props) => {
    ...
    const { main } = state;
    const { updateAutoManSelection, updateMainManualOn, updateMainManualOff } = reducer;
    return (React.createElement("div", { className: "hmi-component-command-valve-mp hmi-component-command-valve-mp__grid" },
        ...
        React.createElement("div", { role: "group", className: "button-group outlined main-auto-manual" },
            React.createElement("button", { className: "button outlined selected", disabled: false, onClick: () => handleMainAutoManualSelection("auto") }, "Auto "),
            React.createElement("button", { className: "button outlined", disabled: false, onClick: () => handleMainAutoManualSelection("manual") }, "Manual")),
        React.createElement("div", { role: "group", className: "button-group outlined main-on-off" },
            React.createElement("button", { className: "button outlined", disabled: false, onClick: handleMainManualOn }, "On "),
            React.createElement("button", { className: "button outlined", disabled: false, onClick: handleMainManualOff }, "Off"))));
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CommandValveMp = exports.ParameterListComponent = exports.Valve = void 0;
const perspective_client_1 = __webpack_require__(/*! @inductiveautomation/perspective-client */ "@inductiveautomation/perspective-client");
