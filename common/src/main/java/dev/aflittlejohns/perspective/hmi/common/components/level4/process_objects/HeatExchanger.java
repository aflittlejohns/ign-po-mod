...
public class HeatExchanger {
	...
	public static String COMPONENT_ID = "hmi.process_objects.HeatExchanger";

	// Path to the thumbnail image for the component palette
	private static final String THUMBNAIL_PATH = "/images/process-objects/heat-exchanger/thumbnail/base.png"; // TODO: Change this to a valve image
	...
	private static final String PROPS_SCHEMA_PATH = "/props/process-object-heat-exchanger.props.json";

	// Component metadata
	private static final String COMPONENT_NAME = "Heat Exchanger";
	private static final String COMPONENT_DESCRIPTION = "A configurable Process HX";
	private static final String COMPONENT_DEFAULT_NAME = "heat-exchanger";
