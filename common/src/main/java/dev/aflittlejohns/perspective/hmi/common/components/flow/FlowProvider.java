...
public class FlowProvider {
	...
	public static String COMPONENT_ID = "hmi.flow.FlowProvider";
	...
	private static final String PROPS_SCHEMA_PATH = "/props/flow-provider.props.json";

	// Component metadata
	private static final String COMPONENT_NAME = "React Flow Provider";
	private static final String COMPONENT_DESCRIPTION = "React Flow Provider";
	private static final String COMPONENT_DEFAULT_NAME = "react-flow-provider";
