...
public class FlowNode {
	...
	public static String COMPONENT_ID = "hmi.flow.FlowNode";
	...
	private static final String PROPS_SCHEMA_PATH = "/props/flow-node.props.json";

	// Component metadata
	private static final String COMPONENT_NAME = "Flow Node";
	private static final String COMPONENT_DESCRIPTION = "flow node";
	private static final String COMPONENT_DEFAULT_NAME = "flow-node";
